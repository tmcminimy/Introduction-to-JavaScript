...
<body>
	<input type='number' placeholder='Enter distance in km' id='km' />
	<input type='button' onClick='km2mi()' value='Convert' />
</body>
<script>
	var factor = 0.621371
	...
	function km2mi(){
		mi.value=(km.value*factor)
		alert(km.value+' km is equal to '+mi.value+' miles')
		}
</script>
...
function letterGrade () {
    ...
    }else if (grading >= 80 && <=89){
        console.log("You got a B")
    }else if (grading >= 70 && <=79){
        console.log("You got a C")
    }else if (grading >= 60 && <=69){
